...
AKS doesn't have support in cluster-autoscaler as of now, but there's an [issue](https://github.com/kubernetes/autoscaler/issues/753) you can track here for progress.
